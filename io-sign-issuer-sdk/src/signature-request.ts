...
export const callSignatureRequests = async (
  ...
  try {
    await createSignatureRequest(configuration, data.signatureRequest, data.documentsMetadata).then(
...
//                      expiresAt: signatureRequest.expiresAt
	...
	if(documentsMetadata) {
		createSignatureRequestBody.documentsMetadata= documentsMetadata;
	}
